plot('convergence_single_curve_forwards') {
    params = [
            xLabel: 'Time [years]',
            yLabel: 'Forward Rate [\\\\%]',
...
plot('convergence_single_curve_caplets') {
    params = [
    ...
    execute = {
        Map fileToProduct = [
                'results/pricing_2015_convergence/1000_multiplicative_1/initial_calibration' : [ 'Analytic': 'Caplet Vola Analytic Single-Curve ',
                                                                                                 '1x1000': 'Caplet Vola Monte-Carlo Single-Curve'],
                'results/pricing_2015_convergence/10000_multiplicative_1/initial_calibration' : [ '1x10000': 'Caplet Vola Monte-Carlo Single-Curve ' ],
                'results/pricing_2015_convergence/100000_multiplicative_1/initial_calibration' : [ '1x100000': 'Caplet Vola Monte-Carlo Single-Curve ' ],
                'results/pricing_2015_convergence/1000000_multiplicative_1/initial_calibration' : [ '10x100000': 'Caplet Vola Monte-Carlo Single-Curve ' ]
        ]
        plotFromCSV(fileToProduct)
    }
}
...
plot('convergence_single_curve_caplets') {
    ...
    execute = {
        Map fileToComparisons = [
                'results/pricing_2015_convergence/1000_multiplicative_1/initial_calibration' : [ '1x1000': [ 'Caplet Vola Analytic Single-Curve ', 'Caplet Vola Monte-Carlo Single-Curve ' ] ],
                'results/pricing_2015_convergence/10000_multiplicative_1/initial_calibration' : [ '1x10000': [ 'Caplet Vola Analytic Single-Curve ', 'Caplet Vola Monte-Carlo Single-Curve ' ] ],
                'results/pricing_2015_convergence/100000_multiplicative_1/initial_calibration' : [ '1x100000': [ 'Caplet Vola Analytic Single-Curve ', 'Caplet Vola Monte-Carlo Single-Curve ' ] ],
                'results/pricing_2015_convergence/1000000_multiplicative_1/initial_calibration' : [ '10x100000': [ 'Caplet Vola Analytic Single-Curve ', 'Caplet Vola Monte-Carlo Single-Curve ' ] ]
        ]
        plotErrors(fileToComparisons)
    }
}