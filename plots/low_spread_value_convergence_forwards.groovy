plot('convergence_low_spread_value_forwards_additive') {
    params = [
            xLabel: 'Time [years]',
            yLabel: 'Forward Rate [\\\\%]',
...
plot('convergence_low_spread_value_forwards_multiplicative') {
    params = [
            xLabel: 'Time [years]',
            yLabel: 'Forward Rate [\\\\%]',
            caption: 'Convergence of the LIBOR curve to the OIS curve for spreads converging to 0.',
...
plot('convergence_low_spread_value_forwards_martingale') {
    params = [
            xLabel: 'Time [years]',
            yLabel: 'Forward Rate [\\\\%]',
            caption: 'Convergence of the LIBOR curve to the OIS curve for spreads converging to 0.',
